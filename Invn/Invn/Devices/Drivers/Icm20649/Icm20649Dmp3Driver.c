...
int dmp_set_data_interrupt_control_20649(struct inv_icm20649 * s, uint32_t interrupt_ctl)
{
    ...
    result = inv_icm20649_write_mems(s, DATA_INTR_CTL, 2, inv_icm20649_convert_int16_to_big8(interrupt_ctl, big8));
...
int dmp_set_data_rdy_status_20649(struct inv_icm20649 * s, unsigned short data_rdy)
{
    ...
    result = inv_icm20649_write_mems(s, DATA_RDY_STATUS, 2, inv_icm20649_convert_int16_to_big8(data_rdy, big8));
