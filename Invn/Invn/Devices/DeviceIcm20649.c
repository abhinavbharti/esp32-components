...
int inv_device_icm20649_reset(void * context)
{
	...
	if(rc != 0) {
		INV_MSG(INV_MSG_LEVEL_ERROR, "Icm20649 reset returned %d", rc);
		return rc;
	}
...
int inv_device_icm20649_setup(void * context)
{
	...
	INV_MSG(INV_MSG_LEVEL_INFO, "Booting up Icm20649...");
	...
	INV_MSG(INV_MSG_LEVEL_VERBOSE, "Putting Icm20649 in sleep mode...");
